...
class Note:
    ...
    def __init__(self, memo, tags=""):
        """initialize a not with memo and optional space-separated tags.
         Automatically set the note's createion date and a unique id."""
        self.memo = memo
        self.tags = tags
        self.createion_date = datetime.date.today()
        global last_id
        last_id += 1
        self.id = last_id

    def match(self, filter):
        """Detetmine if this note matches the filter text.
        Return True if it matches, Galse otherwise.
        Search is case senstive and matches both text and tags."""
...
class Notebook:
    ...
    def new_note(self, memo, tags=""):
        """Create a new note and add it to list"""
